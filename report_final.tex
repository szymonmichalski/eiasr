...
\begin{figure}[!htbp]
  ...
  \hfill
  \subfloat[Apple as classified cauliflower]{\includegraphics[width=0.4\textwidth]{results/apple_cauliflower.jpg}}
  \hfill
...
\begin{figure}[!htbp]
  ...
  \hfill
  \subfloat[Broccoli as classified apple]{\includegraphics[width=0.4\textwidth]{results/broccoli_apple.jpg}}
  \hfill
...
\begin{figure}[!htbp]
  ...
  \hfill
  \subfloat[Cauliflower as classified other]{\includegraphics[width=0.4\textwidth]{results/cauliflower_other.jpg}}
  \hfill
